...
This is a smart walkie talkie using an ESP32 development board. It functions as a walkie talkie. It uses a LoRa module to send radio signals 1 km+, and has smart features such as a low battery alert and a RSSI Signal Bar.
...
|------|-----|-------------|------------|-------------|-----|
| 3.7V 103450 Polymer Lithium Battery, 2000 mAh Rechargeable | 1 | BATTERY LITH-ION 3.7V 2AH | $14.00 | $14.00 | [AliExpress](https://www.aliexpress.us/item/3256802548415679.html?gatewayAdapt=glo2usa4itemAdapt) |
...
| 200PCS Electrolytic Capacitor Kit | 1 | Need 10 µF capacitors (2) & 100 nF capacitors (4) | $6.99 | $6.99 | [Amazon](https://www.amazon.com/200PCS-Electrolytic-Capacitor-Kit-Electronics/dp/B0FH1R7N94/ref=sr_1_2_sspa?dib=eyJ2IjoiMSJ9.OMAhckewDdw7ify-8AoPOqz_gRKEOs7PrXubTDv_IrnqE-pCWep-2HHho33XzUXamlij6VsJuoVNh_0FHktFfNu5BPBjHngwGnkQ7zuHS2uhGOYp0jAqvqPM4WMEI5p5J8kIc-XjDnC4Z1ATiYH35C9yHbJ3CBqhI5scAxo_4OpD8-R6mDwDFVbQqv9H1C4NQNX7lpbC-xq2MzFCFxcV9Hzfsl-Z4JdB4BSZmrZdPdI.CYtiawMHvSGW2pRSlFQQK6yixQgZ9CWyUhQ2rlC-fYs&dib_tag=se&keywords=capacitors&qid=1762786945&sr=8-2-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1) |
| SX1272IMLTRT | 2 | LoRa transceiver module | $8.85 | $17.70 | [DigiKey](https://www.digikey.com/en/products/detail/semtech-corporation/SX1272IMLTRT/4259549) |
| JST_PH_S2B-PH-K_1x02_P2.00mm_Horizontal | 10 | Headers for 3.7v LiPo Batteries | $0.10 | $1.00 | [DigiKey](https://www.digikey.com/en/products/detail/jst-sales-america-inc/S2B-PH-K-S/926626) |
...
| SW_Push | 6 | Push button switch | - | - | - |
| 10 k resistor | 2 | Resistor for pull-ups | - | - | - |

**Total without Tax: $94.22**  
**Total Funding Needed: $119.27**
