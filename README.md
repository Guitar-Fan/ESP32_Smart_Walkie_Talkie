...
| Need 10 µF capacitors (2) & 100 nF capacitors (4) | 1 | Decoupling Capacitors | Exclude | Exclude | Exclude |
| SW_Push | 6 | Push button switch | Exclude | Exclude | Exclude |
| 10 k resistor | 2 | Resistor for pull-ups | Exclude | Exclude | Exclude |

**Note:** My build needs 2 of each component(s) to test

**Total without Tax: $88.95**  
**Total Funding Needed: $110.88**
